$(function() {
    //声明所有的电子邮件变量
    var mail = new Array("126.com", "163.com", "gmail.com", "qq.com", "sohu.com", "139.com");
    //生成一个个li，并加入到ul中
    ...
    $("#umail").keyup(function(event) {
        ...
        if (event.keyCode == 13) {
            $("#umail").val($("ul.list li.lilight:visible").text());
            $("ul.list").hide();
        }
    });

    //监听上下方向键
    $("#umail").keydown(function(event) {
        //下方向键按下了
        if (event.keyCode == 40) {
